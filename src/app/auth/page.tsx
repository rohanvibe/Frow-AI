        ...
        <div className="glass-dark rounded-[2.5rem] p-8 md:p-12 apple-shadow space-y-10 border border-white/5">
           ...
           <div className="space-y-6">
              <Button 
                ...
                disabled={loading}
                className="w-full py-7 rounded-2xl bg-white text-black font-black uppercase tracking-widest text-[10px] hover:bg-gray-200 transition-all active:scale-[0.98] shadow-2xl shadow-white/5 no-border flex items-center justify-center gap-3"
              >
              ...
              <form onSubmit={handleAuth} className="space-y-6">
                <div className="space-y-4">
                   <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="w-full bg-white/5 border-white/5 rounded-2xl py-7 px-6 text-sm font-bold text-white placeholder-gray-700 focus:ring-1 focus:ring-blue-500/30 outline-none transition-all"
                      />
                   </div>
                   <div className="space-y-2">
                ...
                {error && (
                  <motion.p 
                    ...
                    className={`text-[10px] font-black uppercase tracking-widest text-center ${error.includes('Check your email') ? 'text-green-500' : 'text-red-500'}`}
                  >
                    {error}
                  </motion.p>
                )}
